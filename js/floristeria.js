...
function setUpPagina() {
    ...
    cargarDias();
        ...
        function personalizado() {
            ...
            if(mensaje)  //si el id check1 esta chekeado(ticado) hazme todo esto
            {
        ...
        function radiobuttom() {
            var mensaje1 = document.getElementById('mensajes1').checked;
            var mensaje2 = document.getElementById('mensajes2').checked;
            var mensaje3 = document.getElementById('mensajes3').checked;
            var mensaje4 = document.getElementById('mensajes4').checked;
            if (mensaje1) {
               document.getElementById('mensajes2').checked=false;
               document.getElementById('mensajes3').checked=false;
               document.getElementById('mensajes4').checked=false; 
...
function cvv() {
    window.alert("Hace referencia a las 3 cifras de la parte posterior de la tarjeta de crédito")
}
